...
const openFolder: WatermarkEntry = { text: localize('watermark.openFolder', "open a folder"), id: 'workbench.action.files.openFolder' };
...
const openRecent: WatermarkEntry = { text: localize('watermark.openRecent', "open a recent"), id: 'workbench.action.openRecent' };
